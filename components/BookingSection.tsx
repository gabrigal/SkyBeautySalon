...
const SERVICE_CATEGORIES = [
  ...
  },
  {
    ...
    services: [
      ...
      { id: "sp-medium",     label: "Full Color — Medium Length", price: "$75",         duration: "90 min",  durationMins: 90  },
      { id: "sp-long",       label: "Full Color — Long Length",   price: "$85",         duration: "2 hrs",   durationMins: 120 },
      { id: "glaze",         label: "Glaze or Semi-Permanent",    price: "$50",         duration: "60 min",  durationMins: 60  },
      { id: "glaze-post",    label: "Glaze Post Color",           price: "$35",         duration: "30 min",  durationMins: 30  },
      { id: "b3-bond",       label: "B3 Color Add On",            price: "$35",         duration: "30 min",  durationMins: 30  },
