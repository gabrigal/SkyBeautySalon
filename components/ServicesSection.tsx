...
const CATEGORIES = [
  ...
  },
  {
    ...
    services: [
      ...
      { name: "Full Color — Medium Length",      price: "$85"  },
      { name: "Full Color — Long Length",        price: "$120" },
      { name: "Glaze or Semi-Permanent Color",   price: "$55"  },
      { name: "Glaze Post Color",                price: "$55"  },
      { name: "B3 Color Add On",                 price: "$60"  },
