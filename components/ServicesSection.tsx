...
const CATEGORIES = [
  {
    ...
    priceRange: "$18 – $70",
    services: [
      { name: "Women's Haircut",              price: "$40 – $65" },
      { name: "Men's Haircut",                price: "$25 – $30" },
      { name: "Children's Haircut",           price: "$18 – $25" },
      { name: "Blow Dry",                     price: "$30 – $40" },
      { name: "Formal Styling / Up-do / Bridal", price: "$50 – $70" },
    ],
  },
  {
    label: "Color",
    priceRange: "$30 – $80",
    services: [
      { name: "Touch Up",                     price: "$55 – $60" },
      { name: "Single Process — Medium Length", price: "$60" },
      { name: "Single Process — Long Length", price: "$80" },
      { name: "Glaze or Semi-Permanent Color", price: "$60" },
      { name: "Glaze Post Color",             price: "$30" },
      { name: "B3 Brazilian Bond Builder",    price: "$30" },
    ],
  },
  {
    ...
    priceRange: "$125 – $180",
    services: [
      { name: "Full Highlight",               price: "$150 – $170" },
      { name: "Partial Highlight",            price: "$125 – $145" },
      { name: "Balayage or Ombré",            price: "$155 – $180" },
  ...
  },
  {
    ...
    services: [
      ...
      { name: "Treatment Keratin",            price: "$100 – $200" },
      { name: "Brazilian Blow Out",           price: "$100 – $200" },
      { name: "Japanese Straightening",       price: "$150 – $300" },
      { name: "Hair Botox Treatment",         price: "$100 – $200" },
    ],
  },
  {
    label: "Treatment",
    priceRange: "$30 – $100",
    services: [
      { name: "Moroccan Oil Treatment",       price: "$30 – $55" },
      { name: "Aveda Dry or Damage Remedy",   price: "$30 – $45" },
      { name: "B3 Treatment or B3 Package",   price: "$40 – $60" },
