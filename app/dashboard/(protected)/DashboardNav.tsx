...
export function MobileBottomNav() {
  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-[#000000] border-t border-[#222222] flex z-50 safe-area-pb">
      {navLinks.map(({ href, label, icon }) => {
        ...
        return (
          <Link
            ...
            href={href}
            className={clsx(
              'flex-1 flex flex-col items-center justify-center py-2 gap-0.5 text-[9px] tracking-widest uppercase transition-colors',
      ...
      <button
        onClick={handleSignOut}
        className="flex-1 flex flex-col items-center justify-center py-2 gap-0.5 text-[9px] tracking-widest uppercase text-[#666666] transition-colors"
      >
        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
